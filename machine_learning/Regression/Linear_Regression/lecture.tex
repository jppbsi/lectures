...
\flushright\includegraphics[scale=0.1]{./figs/Regressao_Linear_Fig1.png} 
...
$\yel{\mbox{Colored box}}$ $\blu{\mbox{Colored box}}$ $\red{\mbox{Colored box}}$ $\gre{\mbox{Colored box}}$
