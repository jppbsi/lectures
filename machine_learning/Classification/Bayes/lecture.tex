...
\begin{align}\nonumber
	...
	&=m_i\log(\sqrt{2\pi\sigma^2_i})^{1/2}+\sum_{x_j\in{\cal X}^1_i}\frac{(x_j-\mu_i)^2}{2\sigma^2_i}\\\nonumber
	&=-\frac{1}{2}\log(2\pi\sigma^2_i)+\sum_{x_j\in{\cal X}^1_i}\frac{(x_j-\mu_i)^2}{2\sigma^2_i}.
\end{align}
}
...
\begin{align}\nonumber
	\sum_{x_j\in{\cal X}^1_i}\log p(x_j|\theta_i)&=-\frac{1}{2}\log(2\pi\sigma^2_i)+\sum_{x_j\in{\cal X}^1_i}\frac{(x_j-\mu_i)^2}{2\sigma^2_i}\\\nonumber
...
\begin{align}\nonumber
	...
	&\implies-m_i\mu_i = -\sum_{x_j\in{\cal X}^1_i}x_j\implies m_i\mu_i=\sum_{x_j\in{\cal X}^1_i}x_j\\
