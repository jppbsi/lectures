...
\Sli{
Colocar figura\newline
\justifying Essencialmente, roteamento de mensagens e convolução são operações que \textbf{agregam} e \textb{processam} informações de uma certa vizinhança para atualizar o valor de um determinado elemento. Em GNNs, cada elemento é um vértice; já em uma CNN cada elemento é um \emph{pixel}.
}
