...
% FIRST SLIDE
\SliTit{{\LARGE Redes Neurais com Perceptron Multicamadas}}{Advanced Institute for Artificial Intelligence -- AI2}{https://advancedinstitute.ai}{João Paulo Papa (UNESP/Bauru)}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ###############################################################################
% SLIDE SUB-TITLE
...
\begin{enumerate}
	...
	\item $\boldsymbol{h}_{\boldsymbol{w}}(\boldsymbol{x}) = \boldsymbol{a}^{(4)}\leftarrow g\left(\boldsymbol{b}^{(4)}\right)$
\end{enumerate}
\null
\par\xdef\tpd{\the\prevdepth}
\end{minipage}
