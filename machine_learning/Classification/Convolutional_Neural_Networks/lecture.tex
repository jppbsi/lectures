...
\end{minipage}%%% to prevent a space
\begin{minipage}{0.5\textwidth}
Cada um dos pontos vermelhos requer $3\times3=9$ operações de multiplicação e $8$ de adição. Desta forma, a convolução de todo o dado de entrada requer $9\times 9 = 81$ operações de multiplicação e $8\times 9= 72$ de adição.
\null
\par\xdef\tpd{\the\prevdepth}
\end{minipage}
}
...
No total, teremos $45+27 = 72$ operações de multiplicação e $30+18 = 48$ operações de adição.
}
