...
\centerline{
\begin{tabular}{cc}
	\includegraphics[scale=0.437]{./figs/CNN_Fig15.eps} &\hspace{1cm}
	\includegraphics[scale=0.437]{./figs/CNN_Fig16.eps} \\
	Convolução convencional & Convolução separada espacial\\
\end{tabular}}
}
